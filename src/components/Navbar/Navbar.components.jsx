...
return(
    ...
    <div className="text-white flex items-center justify-between">
        <div>
            ...
            <span className="text-gray-400 text-xs flex items-center">Jammu<BiChevronRight /></span>
        </div>
...
const NavMd=()=>{
    return (
        <div className="w-full flex items-center gap-3 bg-white py-2 px-3 rounded:md ">
            <BiSearch />
            <input type="search" className="w-full bg-transparent border-none focus:outline-none " placeholder="serach for movies,sports,plays and events" />
        </div>
...
const NavLg=()=>{
    return(
        ...
        <div className="w-full flex items-center gap-3 bg-white py-2 px-3 rounded:md ">
            ...
            <span className="text-gray-200 text-xs flex items-center hover:text-white cursor-pointer">Jammu<BiChevronDown /></span>
            <button className="bg-red-600 text-white px-2 py-1 text-sm rounded">Sign in</button>
            <div>
                <BiMenu className="w-full h-ful text-white" />
            </div>
            </div>
        </div>
    )
